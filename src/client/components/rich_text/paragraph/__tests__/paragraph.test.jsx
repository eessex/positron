...
describe('Paragraph', () => {
  ...
  describe('#editorStateFromHTML', () => {
    ...
    it('Removes links if props.linked is false', () => {
      props.html = htmlWithRichBlocks
      const component = getWrapper(props)
      const editorState = component.instance().editorStateFromHTML(component.props().html)
      component.instance().onChange(editorState)
  ...
  describe('#editorStateToHtml', () => {
    ...
    xit('Removes disallowed blocks from existing content with links', () => {
      props.linked = true
      const disallowedBlocks = convertFromHTML({ entityToHTML })(htmlWithRichBlocks)
      const editorState = EditorState.createWithContent(disallowedBlocks, decorators(true))
      const component = getWrapper(props)
      const html = component.instance().editorStateToHTML(editorState)
  ...
  describe('#handleKeyCommand', () => {
    it('Calls #promptForLink if link-prompt and props.linked', () => {
      props.linked = true
      const component = getWrapper(props)
    ...
    it('Returns not-handled if link-prompt and props.linked is false', () => {
      const component = getWrapper(props)
      component.instance().promptForLink = jest.fn()
      component.update()
